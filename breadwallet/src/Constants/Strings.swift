...
enum S {
    ...
    enum About {
        ...
        static let walletID = NSLocalizedString("About.walletID", value:"Coinsquare Wallet ID", comment: "About screen wallet ID label")
    ...
    enum MenuButton {
        ...
        static let atmCashRedemption = NSLocalizedString("MenuButton.atmCashRedemption", value:"ATM Cash Redemption", comment: "Menu button title")
    }
    ...
    enum HomeScreen {
        ...
        static let activity = NSLocalizedString("HomeScreen.activity", value: "Activity", comment: "Home Screen History and Pending transactions toolbar button")
    }
